...
def run_tunnel():
    ...
    for line in iter(process.stdout.readline, ""):
        ...
        if ".trycloudflare.com" in line:
            ...
            if tunnel_url:
                print("\n" + "="*70)
                print("   ★ SUCCESS! YOUR TRADING AGENT IS NOW LIVE ONLINE ★")
                print("="*70)
                print(f"   Dashboard Link: {tunnel_url}")
                print("="*70)
                print("   Share or open this link on your phone, laptop, or tablet")
                print("   to monitor and manage your trading agent from anywhere!")
                print("="*70)
...
if __name__ == "__main__":
    print("==========================================================")
    print("           EXPOSING TRADING AGENT TO SINGLE LINK")
    print("==========================================================")
