...
@app.get("/logo_title.png")
def get_logo_title():
    from fastapi.responses import FileResponse
    logo_path = os.path.join(os.path.dirname(__file__), "..", "logo_title.png")
    if os.path.exists(logo_path):
        return FileResponse(logo_path, media_type="image/png")
    return Response(status_code=404)

@app.get("/logo_word.png")
def get_logo_word():
    from fastapi.responses import FileResponse
    logo_path = os.path.join(os.path.dirname(__file__), "..", "logo_word.png")
    if os.path.exists(logo_path):
        return FileResponse(logo_path, media_type="image/png")
    return Response(status_code=404)
