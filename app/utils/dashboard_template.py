...
<head>
    ...
    <meta name="description" content="Secure administrative login for XAUUSD Automated Gold Trading Bot.">
    <title>Login | XAUUSD AI Trading OS</title>
...
<body>
    <main class="login-container">
        <h1 class="logo">⚜️ <span>XAUUSD</span> OS</h1>
        <div class="subtitle">Institutional Trading Intelligence Portal</div>
...
<body>
    ...
    <aside>
        <div class="sidebar-header">
            <h1 class="brand">⚜️ <span>XAUUSD</span> OS</h1>
